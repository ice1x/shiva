...
files = [dict(item.json) for item in _input.all()]
...
def build_workflow(config_path):
    ...
    nodes = [webhook, fetch_files, code, llm, post_comment]
    connections = {
        "GitHub PR Webhook": {"main": [[{"node": "Fetch PR Files", "type": "main", "index": 0}]]},
